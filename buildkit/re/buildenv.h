...
namespace re
{
	...
	/**
	 * @brief Populates the specified collection with a flat target dependency set, resolving all target dependences in progress.
	 * 
	...
	/**
	 * @brief Populates the specified collection with a flat target dependency set without resolving any target dependencies.
	 * 
	 * @param pTarget The root target to start with
	 * @param to The destination collection
	 */
